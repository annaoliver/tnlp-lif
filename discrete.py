...
from node import LIFNode,ThreeCompNode_plif3_human, ThreeCompNode, ThreeCompNode_plif3,ThreeCompNode_plif1,ThreeCompNode_tclif,ThreeCompNode_bilinear,ThreeCompNode_plif3_macaque,ThreeCompNode_plif3_mouse
...
class MCQuantiles(nn.Module):
    def __init__(self, 
        ...
        self._node = LIFNode
        self.mc_node = ThreeCompNode_plif3()   #dend neuron
