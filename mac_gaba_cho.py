    ...
    for s_cho in cho_x:
        for echo in range(5):
            for para_gaba in gaba_:
                ...
                # plt.savefig("./macaque/gaba/cho/%f-%d.jpg"%(para_gaba,echo))
                # plt.close()
                ...
                np.savez('./macaque/gaba/cho/gaba%f-echo%d-s%f.npz'%(para_gaba,echo,s_cho),**array_dict)
