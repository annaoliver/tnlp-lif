...
def main(args=get_args()):
    ...
    # log
    log_path = os.path.join(args.logdir, args.task, 'ThreeCompNode_plif3', args.prefix)
    ...
    def train_fn(epoch, env_step):
        ...
        if env_step % 100== 0:
            ...
            #net.mcquantiles.mc_node.save_spikes(env_step,save_path='./spike/mouse/')
