...
def main_work():
    ...
    # g_m_I = g_i * nS
    # membrane capacitance
    # Rin_e1=rand_seq(174,16,int(N_E/2))* 1e6
    # Rin_e2=rand_seq(332,28,int(N_E/2))* 1e6
    # Rin_i1=rand_seq(118,7,int(N_I/2))* 1e6
    # Rin_i2=rand_seq(261,42,int(N_I/2))* 1e6
    # tau_me1=rand_seq(19.6,0.9,int(N_E/2))/1000
    # tau_me2=rand_seq(20.8,2.3,int(N_E/2))/1000
    # tau_mi1=rand_seq(17.2,0.7,int(N_I/2))/1000
    # tau_mi2=rand_seq(25.3,3,int(N_I/2))/1000
    # c_e1=tau_me1/Rin_e1* 1e12 
    # c_e2=tau_me2/Rin_e2* 1e12 
    # c_e = np.concatenate([c_e1,c_e2])
    # C_m_E=c_e*pF
    ...
    for echo in range(5):
        for para_ee in ee_:
            ...
            plt.savefig("./macaque/ee/uncho/%f-%d.jpg"%(para_ee,echo))
            plt.close()
            ...
            np.savez('./macaque/ee/uncho/%f-%d.npz'%(para_ee,echo),**array_dict)
